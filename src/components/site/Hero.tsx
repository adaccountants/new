    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto grid w-full max-w-7xl items-center gap-10 px-6 pt-10 pb-4 lg:grid-cols-[1.05fr_0.95fr] lg:px-12 lg:pt-16">
        <div className="relative z-10 max-w-[62%] sm:max-w-[58%] lg:max-w-none">
          ...
          <h1 className="mt-6 font-display text-[2rem] leading-[1.05] font-bold tracking-tight text-foreground sm:text-5xl lg:text-[4.2rem]">
          ...
          <div className="mt-9 flex flex-col items-start gap-4 sm:flex-row sm:flex-wrap sm:items-center sm:gap-5">
            <Link
              to="/services"
        ...
        <div className="pointer-events-none absolute right-0 bottom-0 w-[58%] sm:right-0 sm:w-[52%] lg:pointer-events-auto lg:relative lg:inset-auto lg:w-auto">
          <div className="pointer-events-none absolute inset-x-0 top-[18%] bottom-[4%] rounded-full bg-brand/20 blur-[2px] sm:inset-x-6 lg:top-[12%] lg:bottom-0" />
          <picture>
